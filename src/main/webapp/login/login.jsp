    ...
    <script>
        $(function(){
            ...
            $("#captchaImage").click(function(){
                $("#captchaImage").attr('src',"${path}/admin/getInputCode?"+new Date().getTime());
            });
                    ...
                    $.ajax({
                        ...
                        success:function(result){
                            if(result.success){
                                ...
                                //展示错误信息
                                $("#msgDiv").html("<span style='color:red'>"+result.message+"</span>");
                            }
                        }
                    });
                }
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="" method="post" class="login-form" id="loginForm">
                            ...
                            <div class="form-group">
                                ...
                                <img id="captchaImage" style="height: 48px" class="captchaImage" src="${path}/admin/getInputCode">
                                <input  minlength="4" style="width: 268px;height: 50px;border:3px solid #ddd;border-radius: 4px;" required type="test" name="inputCode" id="form-code">
                            </div>
